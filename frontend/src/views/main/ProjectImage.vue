...
<div class="img-container">
  <h1>저장된 이미지</h1>
  <div class="window" v-if="demeet.imageList">
    <div 
    class="container"
  ...
  async setup() {
    ...
    function init () {
      ...
      function translateContainer(direction){
        ...
        container.style.transform = `translateX(${direction * (100 / 4)}%)`;
